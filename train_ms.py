...
def run(rank, n_gpus, hps):
  ...
  try:
    _, _, _, epoch_str = utils.load_checkpoint(os.path.join(hps.model_dir, "G.pth"), net_g, optim_g)
    _, _, _, epoch_str = utils.load_checkpoint(os.path.join(hps.model_dir, "D.pth"), net_d, optim_d)
